...
//hist was filled with: log10(pt+0.01)
    ...
    // Depending on your wish, you can iterate over nodes, jump to
    // them in navigator and extract parameters
...
//    }
    ...
    z = gRandom->Uniform(global_coords[2] - brick->GetDZ(), global_coords[2]);
    x = gRandom->Uniform(- emulsion->GetDX(), emulsion->GetDX());
    y = gRandom->Uniform(- emulsion->GetDY(), emulsion->GetDY());
