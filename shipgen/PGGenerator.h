 ...
 *
 * The PGGenerator generates particles within given range
 * over pt, phi, eta, y or theta a fixed multiplicity per event.
 * Derived from FairGenerator.
**/

/* $Id: PGGenerator.h,v 1.3 2006/07/14 11:23:57 kharlov Exp $ */
...
#ifndef PNDpgGENERATOR_H
#define PNDpgGENERATOR_H 1
...
class PGGenerator : public FairGenerator
{
  public:
     ...
     **/
    PGGenerator(Int_t pdgid, Int_t mult=1);
    ...
    static size_t usage_counter;

  protected:
    /** Copy constructor. **/
    PGGenerator(const PGGenerator&);
    PGGenerator& operator=(const PGGenerator&);
