 ...
 if hasattr(ship_geo,'tauMudet'): # don't support old designs
  ...
  if ship_geo.muShieldDesign not in [2,3,4] and hasattr(ship_geo.tauMudet,'Xtot'):
   ...
   NuTauTarget.SetBrickParam(ship_geo.NuTauTarget.BrX, ship_geo.NuTauTarget.BrY, ship_geo.NuTauTarget.BrZ,
                             ship_geo.NuTauTarget.BrPackX, ship_geo.NuTauTarget.BrPackY, ship_geo.NuTauTarget.BrPackZ, ship_geo.NuTauTarget.n_films)
...
#
 exclusionList = []
 #exclusionList = ["Muon", "Ecal", "Hcal", "Strawtubes", "Veto", "Magnet", "TimeDet"]
