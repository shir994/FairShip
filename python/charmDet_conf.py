...
# -----Create geometry----------------------------------------------
 ...
 if ship_geo.muShieldDesign == 20:
  Veto.SetSensePlaneZ(7, ship_geo.SensPlane.z_1, ship_geo.SensPlane.z_2, ship_geo.muShield.Start_Z - 10*u.cm, ship_geo.muShield.Start_Z + ship_geo.muShield.Z + 10*u.cm, ship_geo.muShield.Start_Z + 2*ship_geo.muShield.Z + ship_geo.muShield.Gap + 10*u.cm, ship_geo.muShield.Start_Z + 3*ship_geo.muShield.Z + 2*ship_geo.muShield.Gap + 10*u.cm,  ship_geo.muShield.Start_Z + 4*ship_geo.muShield.Z + 3*ship_geo.muShield.Gap + 10*u.cm, ship_geo.muShield.Start_Z + 4*ship_geo.muShield.Z + 3*ship_geo.muShield.Gap + 110*u.cm)
 else:
  Veto.SetSensePlaneZ(3, ship_geo.SensPlane.z_1, ship_geo.SensPlane.z_2, ship_geo.SensPlane.z_3)
